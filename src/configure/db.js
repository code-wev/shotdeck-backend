...
try {
    const connect = await mongoose.connect('mongodb+srv://kuryemshtodeck:z5eMzIIpzhOGqYyJ@cluster0.5sfxlm2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"', {
        dbName: 'shotdeck', 
      });
